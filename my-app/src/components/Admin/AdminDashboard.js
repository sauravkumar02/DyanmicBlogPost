...
const AdminDashboard = ({ searchQuery }) => {
  ...
  const deleteBlog = async (e) => {
    ...
    let response = await fetch(`http://localhost:3001/blog/${e}`, {
      method: "DELETE",
      headers: headersList,
    });
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-end">
                    <button
                      className="bg-blue-500 text-white px-1 py-1 mr-2 mt-4 text-xs"
                      onClick={() => openUpdateform(e)}
                    >
                      Update
                    </button>
                    <button
                      className="bg-red-500 text-white px-2 py-1 mt-4 text-xs"
